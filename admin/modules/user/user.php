...
$row_per_page = 10; //so row trong 1 trang
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table 
                        ...
                        <tbody>
                        <?php
                        $sql = "SELECT * FROM user ORDER BY user_id ASC LIMIT $per_rows, $row_per_page";
                        ...
                        ?>
                            <tr>
                                ...
                                if($row['user_level']==2) echo '<td><span class="label label-warning">Member</span></td>';
                                ?>
                                <td class="form-group">
                                    <a href="index.php?page_layout=edit_user&user_id=<?=$row['user_id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                    <a href="modules/user/del_user.php?user_id=<?=$row['user_id'] ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
